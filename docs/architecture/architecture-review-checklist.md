...
- `TestA1688ListingKitCommandReadsIdentityFromNeutralContext`
...
- `TestListingKitAuthenticatedIdentityCompatibilityFacadeIsRetired`
- `TestListingKitAuthenticatedIdentityDeclarationScannerRejectsMovedFacade`
...
- `TestAppConsumerRuntimeBoundariesDoNotCarryRetiredManagementService`
...
- `TestPlatformProcessorRegistryDoesNotImplementPlatformModuleCatalog`
- `TestPlatformModuleCatalogStaysPackageInternal`
- `TestPlatformProcessorRegistryDoesNotComputePlatformResourceNeeds`
...
- `TestListingRuntimeDependenciesTypeStaysPackageInternal`
- `TestDependenciesExposeListingRuntimeHealthValidatorInsteadOfSharedResources`
- `TestListingRuntimeDoesNotImportBootstrapResources`
- `TestRootBootstrapListingRuntimeDependenciesFacadeStaysRetired`
- `TestListingRuntimeLocalCompatibilityFacadeStaysRetired`
...
- `TestAppRuntimeLegacyAppConfigFlagsStayRetired`
...
- `TestSharedResourcesUsesNamedListingRuntimeHealthValidatorPort`
- `TestBootstrapProcessorAndSchedulerFacadesStayRetired`
...
- `TestListingAdminStorePageResponseAliasStaysRetired`
...
- `TestAmazonUsesManagementAPIPortAliases`
...
- `TestTemuContextUsesManagementAPIPortAliases`
- `TestTemuRootUsesManagementAPIPortAliases`
- `TestTemuFilterUsesManagementAPIPortAliases`
- `TestTemuRulesUsesManagementAPIPortAliases`
- `TestTemuHandlerBaseUsesManagementAPIPortAliases`
- `TestTemuStoreUsesManagementAPIPortAliases`
- `TestTemuSkuUsesManagementAPIPortAliases`
- `TestTemuProductUsesManagementAPIPortAliases`
- `TestTemuPricingUsesManagementAPIPortAliases`
- `TestTemuSyncUsesManagementAPIPortAliases`
...
- `TestRetiredManagementServiceHotspotsUseCapabilityNames`
...
- `TestStateAndTaskRPCUseManagementAPIPortAliases`
...
- `TestSheinLoginUsesManagementAPIPortAliases`
- `TestSheinPipelineRuntimeDependenciesDoNotUseRetiredManagementNames`
