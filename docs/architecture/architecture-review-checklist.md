...
- `TestAppConsumerRuntimeBoundariesDoNotCarryManagementClient`
- `TestPlatformProcessorRegistryDoesNotStoreManagementClient`
...
- `TestSheinPipelineRuntimeDependenciesDoNotUseManagementClientNames`
