...
internal/listingkit/service_ai_client_settings_admin_facade.go // AI client settings facade delegates
internal/listingkit/service_child_task_retry_facade.go   // child task retry logic
...
internal/listingkit/service_shein_final_draft_update_facade.go // SHEIN final draft facade delegate
...
internal/listingkit/service_shein_resolution_cache_clear_facade.go // SHEIN resolution cache facade delegate
internal/listingkit/service_shein_submission_event_list_facade.go // SHEIN submission event facade delegate
internal/listingkit/service_shein_store_selection_resolvers.go // SHEIN store selection helpers
internal/listingkit/service_shein_settings_admin_facade.go // SHEIN settings facade delegates
internal/listingkit/service_store_profile_routing_facade.go // store profile / routing facade delegates
...
internal/listingkit/service_task_sds_baseline_warm_facade.go // task SDS baseline facade delegates
...
### `service_store_profile_routing_facade.go`
...
### `service_ai_client_settings_admin_facade.go`

Owns root AI client settings facade delegates:

- AI client settings fetch / update.

### `service_shein_settings_admin_facade.go`
...
### `service_shein_final_draft_update_facade.go`
...
### `service_shein_resolution_cache_clear_facade.go`

Owns root SHEIN resolution cache facade delegate:

- SHEIN resolution cache clear entrypoint.

### `service_shein_submission_event_list_facade.go`
...
### `service_task_sds_baseline_warm_facade.go`
