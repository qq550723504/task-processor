...
internal/listingkit/service_shein_pricing_preview_facade.go // SHEIN pricing preview facade delegate
...
internal/listingkit/service_sds_baseline_warmup_facade.go // SDS baseline facade delegates
...
internal/listingkit/service_shein_publish_temporal_facade.go // SHEIN publish Temporal facade delegates
...
### `service_shein_pricing_preview_facade.go`
...
### `service_sds_baseline_warmup_facade.go`

Owns root SDS baseline facade delegates:
...
- `service_shein_publish_temporal_facade.go`: root-facing Temporal SHEIN submit and preview delegates,
