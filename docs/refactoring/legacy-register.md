...
- Existing `TestPhase3LegacyProductRootsAreAbsent`, `TestPhase3LegacyProductImportDeclarationsAreAbsent`, and `phase3_retired_product_imports` keep ProductEnrich/ProductImage/catalog/asset/imageasset retired. The preview adapter has an explicit absence test.
