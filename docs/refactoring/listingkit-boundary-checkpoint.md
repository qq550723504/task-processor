...
- SHEIN submit image URL classification now lives in `internal/marketplace/shein/publishing`; `internal/publishing/shein` keeps product/image count and upload-cache adapters while delegating uploaded/SDS host policy.
