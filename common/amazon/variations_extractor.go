...
import (
	"task-processor/common/amazon/variations"
...
// 辅助函数：转换类型
func convertToVariationsValues(values []VariationValue) []variations.VariationValue {
...
func convertToAmazonVariations(varList []variations.Variation) []Variation {
	result := make([]Variation, len(varList))
