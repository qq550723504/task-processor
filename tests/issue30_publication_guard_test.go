...
func TestIssue30PublicationGuardReferenceForms(t *testing.T) {
	for _, tc := range []struct {
		...
		{"admitted browser construction", "internal/app/productsourcing/browser_capture.go", `package productsourcing; import s "task-processor/internal/product/sourcing"; type BrowserCaptureService struct{}; func (*BrowserCaptureService) Capture() { s.PublicationIdentity() }`, 0},
		{"browser fake suffix", "internal/app/productsourcing/browser_capture.go.fake.go", `package productsourcing; import s "task-processor/internal/product/sourcing"; var use = s.PublicationIdentity`, 1},
		{"browser nested", "internal/app/productsourcing/child/browser_capture.go", `package productsourcing; import s "task-processor/internal/product/sourcing"; var use = s.PublicationIdentity`, 1},
		{"browser sibling", "internal/app/productsourcing/other_browser.go", `package productsourcing; import s "task-processor/internal/product/sourcing"; var use = s.PublicationIdentity`, 1},
