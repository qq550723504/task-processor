...
func TestListingKitWorkloadsUseLeastPrivilegeSharedSecretKeys(t *testing.T) {
	want := map[string]map[string]string{
		"base/listingkit-ui-deployment.yaml": {
			...
			"LISTINGKIT_ZITADEL_ALLOWED_ROLES": "LISTINGKIT_ZITADEL_ALLOWED_ROLES",
		...
		"base/shein-login-worker-deployment.yaml": {
			...
			"TASK_PROCESSOR_SHEIN_LOGIN_SERVICE_IDENTIFIER": "TASK_PROCESSOR_SHEIN_LOGIN_SERVICE_IDENTIFIER",
		},
