...
func issue398AcquisitionAPIViolations(sources []listingKitImageBoundarySource) ([]string, error) {
	...
	rules := []struct {
		...
		{"internal/app/httpapi/product_acquisition_application.go", "internal/app/httpapi/product_acquisition_application.go", "task-processor/internal/app/productsourcing", []string{"NewPublicAcquisition", "PublishedAcquisition", "NewBrowserAcquisition"}},
	}
