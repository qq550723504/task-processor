...
func main() {
	var (
		...
		outputPath          = flag.String("output", ".tmp/listingkit-owner-scope-dry-run.json", "path to JSON report")
		sqlPath             = flag.String("sql-output", ".tmp/listingkit-owner-scope-dry-run.sql", "path to combined SQL preview output")
		schemaPath          = flag.String("schema-output", ".tmp/listingkit-owner-scope-schema.sql", "path to schema SQL preview output")
		backfillPath        = flag.String("backfill-output", ".tmp/listingkit-owner-scope-backfill.sql", "path to backfill SQL preview output")
		safeBackfillPath    = flag.String("safe-backfill-output", ".tmp/listingkit-owner-scope-safe-backfill.sql", "path to safe backfill SQL preview output")
		manualReviewSQLPath = flag.String("manual-review-output", ".tmp/listingkit-owner-scope-manual-review.sql", "path to manual review SQL preview output")
		tasksJSONPath       = flag.String("unresolved-tasks-json", ".tmp/listingkit-owner-scope-unresolved-tasks.json", "path to unresolved task rows JSON")
		tasksCSVPath        = flag.String("unresolved-tasks-csv", ".tmp/listingkit-owner-scope-unresolved-tasks.csv", "path to unresolved task rows CSV")
		studioJSONPath      = flag.String("unresolved-studio-json", ".tmp/listingkit-owner-scope-unresolved-studio-sessions.json", "path to unresolved studio session rows JSON")
		studioCSVPath       = flag.String("unresolved-studio-csv", ".tmp/listingkit-owner-scope-unresolved-studio-sessions.csv", "path to unresolved studio session rows CSV")
		summaryJSONPath     = flag.String("unresolved-summary-json", ".tmp/listingkit-owner-scope-unresolved-summary.json", "path to grouped unresolved summary JSON")
	)
	flag.Parse()
