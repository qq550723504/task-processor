...
CREATE TABLE public.saas_usage_event_outbox (
...
CREATE TABLE public.saas_subscription_audit_logs (
...
CREATE TABLE public.account_member_token_locks (organization_id varchar(128) PRIMARY KEY, updated_at timestamptz NOT NULL);
...
CREATE ROLE commercial_runtime LOGIN PASSWORD :'commercial_password';
