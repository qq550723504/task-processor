...
GRANT SELECT, INSERT ON TABLE public.referral_earnings_ledger, public.referral_refund_operations, public.referral_withdrawal_operations, public.referral_earnings_audit_events TO referral_runtime;
GRANT SELECT, INSERT ON TABLE public.ledger_payment_settlements, public.ledger_refund_settlements TO referral_runtime;
