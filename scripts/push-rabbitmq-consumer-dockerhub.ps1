# RabbitMQ Consumer Docker image build and push to DockerHub
# Usage: .\push-rabbitmq-consumer-dockerhub.ps1 [-DockerHubUser yourname] [-Tag v1.0.0]
...
$Dockerfile  = "deployments/docker/Dockerfile.rabbitmq-consumer"

# Auto-generate tag from git, fallback to date
if (-not $Tag) {
...
Write-Host "  Build & Push RabbitMQ Consumer" -ForegroundColor Cyan
