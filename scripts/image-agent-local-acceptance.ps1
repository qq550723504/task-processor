...
function Set-LocalAcceptanceEnvironment {
    ...
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_ENABLED = "true"
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_PROVIDER = "s3"
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_PUBLIC_BASE = "https://local.acceptance.invalid/image-agent-assets"
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_S3_BUCKET = "listingkit-assets"
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_S3_REGION = "us-east-1"
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_S3_ENDPOINT = "http://127.0.0.1:$s3Port"
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_S3_ACCESS_KEY_ID = $composeEnv["MINIO_ROOT_USER"]
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_S3_SECRET_ACCESS_KEY = $composeEnv["MINIO_ROOT_PASSWORD"]
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_S3_USE_PATH_STYLE = "true"
    $env:TASK_PROCESSOR_IMAGEAGENT_ARTIFACT_STORE_S3_ARTIFACT_MODE = "aws"
    $env:TASK_PROCESSOR_LISTINGKIT_IMAGE_UPLOAD_PROVIDER = "s3"
    $env:TASK_PROCESSOR_LISTINGKIT_IMAGE_UPLOAD_S3_PUBLIC_BASE = "https://local.acceptance.invalid/image-agent-assets"
    $env:TASK_PROCESSOR_LISTINGKIT_IMAGE_UPLOAD_S3_BUCKET = "listingkit-assets"
    $env:TASK_PROCESSOR_LISTINGKIT_IMAGE_UPLOAD_S3_REGION = "us-east-1"
    $env:TASK_PROCESSOR_LISTINGKIT_IMAGE_UPLOAD_S3_ENDPOINT = "http://127.0.0.1:$s3Port"
    $env:TASK_PROCESSOR_LISTINGKIT_IMAGE_UPLOAD_S3_ACCESS_KEY_ID = $composeEnv["MINIO_ROOT_USER"]
    $env:TASK_PROCESSOR_LISTINGKIT_IMAGE_UPLOAD_S3_SECRET_ACCESS_KEY = $composeEnv["MINIO_ROOT_PASSWORD"]
    $env:TASK_PROCESSOR_LISTINGKIT_IMAGE_UPLOAD_S3_USE_PATH_STYLE = "true"
}
