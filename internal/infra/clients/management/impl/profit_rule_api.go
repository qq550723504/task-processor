...
// ProfitRuleAPIClientImpl 利润规则API客户端实现
type ProfitRuleAPIClientImpl struct {
	*ManagementAPIClientImpl
}

// GetProfitRule 获取利润规则
func (m *ProfitRuleAPIClientImpl) GetProfitRule(req *api.ProfitRuleReqDTO) (*api.ProfitRuleRespDTO, error) {
