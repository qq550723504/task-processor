...
func AppendRouteDescriptors(routes []httproute.Descriptor, handler *Handler) []httproute.Descriptor {
	...
	return append(routes,
		...
		httproute.Descriptor{Method: http.MethodPost, Path: "/api/v1/image-agent/runs/:run_id/slots/:slot_id/attempts/:attempt/recover", Module: ModuleName, Permission: authz.PermissionImageAgentWrite, AuthPolicy: verified, Handler: handler.RecoverEffect},
