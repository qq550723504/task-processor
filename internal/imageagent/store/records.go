...
type runRecord struct {
	...
	BudgetJSON         []byte    `gorm:"type:blob"`
	UsageJSON          []byte    `gorm:"type:blob"`
	BlockJSON          []byte    `gorm:"type:blob"`
...
type planRecord struct {
	...
	SourceAssetIDs    []byte    `gorm:"type:blob"`
	StyleReferenceIDs []byte    `gorm:"type:blob"`
...
type slotRecord struct {
	...
	CandidateAssetIDs []byte    `gorm:"type:blob"`
