...
func (s *productSyncServiceImpl) fillPriceInfo(productData *TemuProductSnapshot, temuProduct *temuproduct.SkuResponse) {
	// 设置原价（使用 price 字段）
...
func (s *productSyncServiceImpl) fillStockInfo(productData *TemuProductSnapshot, temuProduct *temuproduct.SkuResponse) {
	// 使用普通库存
...
func (s *productSyncServiceImpl) fillCategoryInfo(productData *TemuProductSnapshot, temuProduct *temuproduct.SkuResponse) {
	// 设置分类ID
...
func (s *productSyncServiceImpl) fillPlatformData(productData *TemuProductSnapshot, temuProduct *temuproduct.SkuResponse) {
	// 构建平台状态信息
