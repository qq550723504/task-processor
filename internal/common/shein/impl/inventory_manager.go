...
func NewInventoryManager(baseClient *BaseAPIClient, errorHandler *APIErrorHandler) *InventoryManager {
...
func (m *InventoryManager) QueryStock(request *product.StockQueryRequest) (*product.StockQueryResponse, error) {
	url := fmt.Sprintf("%s%s", m.baseClient.GetBaseURL(), queryStockEndpoint)
...
func (m *InventoryManager) QueryInventory(spuName string) (*product.InventoryQueryResponse, error) {
	url := fmt.Sprintf("%s%s", m.baseClient.GetBaseURL(), queryInventoryEndpoint)
...
func (m *InventoryManager) UpdateInventory(request *product.InventoryUpdateRequest) error {
	url := fmt.Sprintf("%s%s", m.baseClient.GetBaseURL(), updateInventoryEndpoint)
