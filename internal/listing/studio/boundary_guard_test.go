...
func TestStudioPackageDoesNotDependOnListingKitMarketplaceOrRuntime(t *testing.T) {
	t.Parallel()
	...
	assertStudioPackageDoesNotImportPrefixes(t, studioPackageDir(t), forbiddenPrefixes)
}

func studioPackageDir(t *testing.T) string {
	t.Helper()
...
func assertStudioPackageDoesNotImportPrefixes(t *testing.T, dir string, forbiddenPrefixes []string) {
	t.Helper()
