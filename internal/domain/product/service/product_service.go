...
type ProductService struct {
	...
	crawlerRepo repo.CrawlerRepository
...
func (s *ProductService) FetchProduct(ctx context.Context, req *types.FetchRequest) (*model.Product, error) {
...
// CacheProduct 缓存产品数据
func (s *ProductService) CacheProduct(ctx context.Context, req *types.FetchRequest, product *model.Product) error {
	if product == nil {
...
func (s *ProductService) CacheVariants(ctx context.Context, req *types.FetchRequest, variants []*model.Product) error {
	if len(variants) == 0 {
...
func (s *ProductService) fetchFromCache(ctx context.Context, req *types.FetchRequest) (*model.Product, error) {
...
func (s *ProductService) fetchFromCrawler(ctx context.Context, req *types.FetchRequest) (*model.Product, error) {
...
func (s *ProductService) saveToCacheAsync(ctx context.Context, req *types.FetchRequest, product *model.Product) {
	defer func() {
		if r := recover(); r != nil {
