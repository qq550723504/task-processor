...
func TestConfigBuild(t *testing.T) {
	...
	v.Set("platforms.shein.loginService.baseURL", "http://login:8000")
	v.Set("platforms.shein.loginService.sharedKey", "shein-key")
	...
	assert.Equal(t, "http://login:8000", cfg.Platforms.Shein.LoginService.BaseURL)
	assert.Equal(t, "shein-key", cfg.Platforms.Shein.LoginService.SharedKey)
