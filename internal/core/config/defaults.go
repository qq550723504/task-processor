...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("listingkit.ownerScopeRequired", defaults.ListingKit.OwnerScopeRequired)
	...
	v.SetDefault("listingkit.zitadel.authRequired", defaults.ListingKit.Zitadel.AuthRequired)
