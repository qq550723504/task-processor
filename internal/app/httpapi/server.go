...
func buildRouteDescriptorsWithShein(productHandler productRouteHandler, imageHandler imageRouteHandler, amazonListingHandler amazonListingRouteHandler, listingKitHandler listingKitRouteHandler, promptTemplateHandler promptTemplateRouteHandler, studioSessionHandler studioSessionRouteHandler, sheinLoginHandler sheinLoginRouteHandler, sdsLoginHandler sdsLoginRouteHandler, taskRPCHandler taskRPCRouteHandler, sdsCatalogHandlers ...sdsCatalogRouteHandler) []routeDescriptor {
	...
	if listingKitHandler != nil {
		routes = append(routes,
			...
			routeDescriptor{Method: http.MethodGet, Path: "/api/v1/listing-kits/stores", Module: "listing-kit", Handler: listingKitHandler.ListTenantStores},
			routeDescriptor{Method: http.MethodGet, Path: "/api/v1/listing-kits/stores/simple", Module: "listing-kit", Handler: listingKitHandler.ListSimpleTenantStores},
			routeDescriptor{Method: http.MethodPost, Path: "/api/v1/listing-kits/stores", Module: "listing-kit", Handler: listingKitHandler.CreateTenantStore},
			routeDescriptor{Method: http.MethodPut, Path: "/api/v1/listing-kits/stores/:id", Module: "listing-kit", Handler: listingKitHandler.UpdateTenantStore},
			routeDescriptor{Method: http.MethodDelete, Path: "/api/v1/listing-kits/stores/:id", Module: "listing-kit", Handler: listingKitHandler.DeleteTenantStore},
			routeDescriptor{Method: http.MethodGet, Path: "/api/v1/listing-kits/store-profiles", Module: "listing-kit", Handler: listingKitHandler.ListSheinStoreProfiles},
			routeDescriptor{Method: http.MethodPost, Path: "/api/v1/listing-kits/store-profiles", Module: "listing-kit", Handler: listingKitHandler.UpsertSheinStoreProfile},
			routeDescriptor{Method: http.MethodDelete, Path: "/api/v1/listing-kits/store-profiles/:id", Module: "listing-kit", Handler: listingKitHandler.DeleteSheinStoreProfile},
			routeDescriptor{Method: http.MethodGet, Path: "/api/v1/listing-kits/store-routing", Module: "listing-kit", Handler: listingKitHandler.GetSheinStoreRoutingSettings},
			routeDescriptor{Method: http.MethodPut, Path: "/api/v1/listing-kits/store-routing", Module: "listing-kit", Handler: listingKitHandler.UpdateSheinStoreRoutingSettings},
			...
			routeDescriptor{Method: http.MethodGet, Path: "/api/v1/listing-kits/platform/subscription-plans/:plan_code/tenants", Module: "listing-kit-platform-admin", Handler: listingKitHandler.ListPlatformSubscriptionPlanTenants},
			routeDescriptor{Method: http.MethodGet, Path: "/api/v1/listing-kits/platform/subscription-plans/:plan_code/audit-logs", Module: "listing-kit-platform-admin", Handler: listingKitHandler.ListPlatformSubscriptionPlanAuditLogs},
