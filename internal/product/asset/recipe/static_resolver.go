...
func newRecipe(id, platform, name string, kind asset.Kind, slot, purpose, templateLabel, renderProfile string, preferred []asset.Kind, optional bool, maxItems int) AssetRecipe {
	return AssetRecipe{
		ID: id, Platform: platform, Name: name, AssetKind: kind,
		...
		Template:  &Template{BundleSlot: slot, Purpose: purpose, TemplateLabel: templateLabel, RenderProfile: renderProfile, PreferredKinds: append([]asset.Kind(nil), preferred...), Optional: optional, MaxItems: maxItems},
	}
}
