...
func (h *TaskErrorHandler) HandleTaskFailure(task modules.Task, err error) {
...
func (h *TaskErrorHandler) HandleAuthenticationExpired(authErr *api.AuthenticationExpiredError, task modules.Task) {
