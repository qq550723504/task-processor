...
func (p *SKCVariantProcessor) BuildSingleVariantSKC(ctx *TaskContext, strategy AttributeStrategy) ([]product.SKC, []attribute.CustomAttributeRelation, error) {
...
func (p *SKCVariantProcessor) BuildMultiVariantSKCList(ctx *TaskContext, strategy AttributeStrategy, variantMatcher *VariantMatcher) ([]product.SKC, []attribute.CustomAttributeRelation, error) {
...
func (p *SKCVariantProcessor) buildSingleVariantDirect(ctx *TaskContext, variant Variant, strategy AttributeStrategy) ([]product.SKC, []attribute.CustomAttributeRelation, error) {
	var customAttributeRelations []attribute.CustomAttributeRelation
...
func (p *SKCVariantProcessor) ensureVariantsHaveRequiredAttributes(ctx *TaskContext, strategy *AttributeStrategy) {
...
func (p *SKCVariantProcessor) variantHasAttribute(variant *Variant, attrName string) bool {
