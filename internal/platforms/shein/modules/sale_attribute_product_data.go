// Package modules 提供SHEIN平台销售属性的产品数据准备功能
package modules
...
func (p *SaleAttributeProductDataPreparer) PrepareProductsData(ctx *TaskContext) []map[string]string {
...
func (p *SaleAttributeProductDataPreparer) prepareSingleProductData(ctx *TaskContext) map[string]string {
...
func (p *SaleAttributeProductDataPreparer) prepareMultiVariantProductsData(ctx *TaskContext) []map[string]string {
	var productsData []map[string]string
	priceType := ctx.StoreInfo.PriceType
