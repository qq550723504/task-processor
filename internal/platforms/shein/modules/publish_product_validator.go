...
func (v *PublishProductValidator) PreValidateProductData(ctx *TaskContext) error {
...
func (v *PublishProductValidator) validateBasicProductInfo(ctx *TaskContext) error {
...
func (v *PublishProductValidator) validateSKCAndSKUData(ctx *TaskContext) error {
	product := ctx.ProductData
...
func (v *PublishProductValidator) generateValidationReport(ctx *TaskContext) *ValidationReport {
	startTime := time.Now()
...
func (v *PublishProductValidator) validateMultiPieceSKUImagesWithReport(ctx *TaskContext, report *ValidationReport) error {
	product := ctx.ProductData
