...
func (f *SaleAttributeVariantFilter) FilterVariantsByRules(ctx *TaskContext) {
	if ctx.Variants == nil {
		return
	}
...
func (f *SaleAttributeVariantFilter) FilterVariantsByRulesAfterGeneration(ctx *TaskContext, saleAttributeData *ResultSaleAttribute) {
