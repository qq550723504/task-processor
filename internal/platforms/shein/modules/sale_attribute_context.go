...
func (c *SaleAttributeContextBuilder) BuildExtraContext(amazonProduct model.Product, variants []model.Product, productsData []ProductVariantData) string {
...
func (c *SaleAttributeContextBuilder) detectMissingInfo(productsData []ProductVariantData) MissingInfoDetection {
