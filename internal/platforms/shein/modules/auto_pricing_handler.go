...
import (
	...
	managementapi "task-processor/internal/common/management/api" // 使用别名避免冲突
	shops "task-processor/internal/common/shein"                  // 导入shein包并使用shops别名
	sheinapi "task-processor/internal/common/shein/api"           // 使用别名避免冲突
