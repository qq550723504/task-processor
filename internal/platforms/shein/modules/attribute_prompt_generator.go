...
func (g *AttributePromptGenerator) GenerateUserPrompt(ctx *TaskContext, enhancedAttributeData []EnhancedGenerateAttribute) string {
...
func (g *AttributePromptGenerator) generateDynamicUserPrompt(ctx *TaskContext, enhancedAttributeData []EnhancedGenerateAttribute) string {
	// 按重要性分组属性
