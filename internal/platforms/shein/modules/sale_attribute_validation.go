...
func (h *SaleAttributeHandler) validateAndFixSaleAttributeData(data ResultSaleAttribute, productsData []map[string]string) ResultSaleAttribute {
...
func (h *SaleAttributeHandler) fixAttributeValueIDsWithManager(data ResultSaleAttribute) ResultSaleAttribute {
...
func (h *SaleAttributeHandler) standardizeDimensionUnits(data ResultSaleAttribute) ResultSaleAttribute {
	// 定义单位映射表
...
func (h *SaleAttributeHandler) validateVariantCompleteness(data ResultSaleAttribute, products []map[string]string) ResultSaleAttribute {
...
func (h *SaleAttributeHandler) validateVariantAttributes(data ResultSaleAttribute, products []map[string]string) ResultSaleAttribute {
