...
// Handle 执行生成销售规格处理
func (h *SaleAttributeHandler) Handle(ctx *TaskContext) error {
	// 检查是否已获取属性模板
...
func (h *SaleAttributeHandler) generateSaleSpec(ctx *TaskContext) error {
...
func (h *SaleAttributeHandler) defaultAttributeConfig() *AttributeConfig {
...
func (h *SaleAttributeHandler) newAttributeImportanceCalculator(rules *ImportanceRules) *AttributeImportanceCalculator {
