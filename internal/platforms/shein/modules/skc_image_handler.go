// Package modules 提供SHEIN平台SKC图片处理功能
package modules
...
func NewSKCImageHandler(imageProcessor *ImageProcessor, taskContext *TaskContext) *SKCImageHandler {
...
func (h *SKCImageHandler) GetVariantSpecificImages(ctx *TaskContext, variant Variant) ([]string, error) {
