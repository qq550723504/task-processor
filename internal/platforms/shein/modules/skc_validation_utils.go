...
func NewSKCValidationUtils(taskContext *TaskContext) *SKCValidationUtils {
...
func (v *SKCValidationUtils) ValidateAttributeStrategy(strategy AttributeStrategy, saleAttributeData ResultSaleAttribute) error {
	var warnings []string
