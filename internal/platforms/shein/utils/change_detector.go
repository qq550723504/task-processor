...
func (d *ChangeDetector) CheckAndNotifyPriceChange(
	...
	newPrice := GetProductPrice(amazonProduct, priceType)
...
func GetProductPrice(product *model.Product, priceType string) float64 {
	if product == nil {
		return 0
	}
...
// extractStockFromProduct 从产品中提取库存
func extractStockFromProduct(product *model.Product) int {
	if product == nil {
		return 0
	}
