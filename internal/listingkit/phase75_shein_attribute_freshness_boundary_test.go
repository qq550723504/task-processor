...
func TestSheinAttributeFreshnessBoundary(t *testing.T) {
	...
	t.Run("attribute_freshness_home_routes_template_context_and_resolved_attribute_home_only", func(t *testing.T) {
		...
		source := readNamedFunctionSource(t, "shein_submit_freshness.go", "evaluateSheinAttributeFreshness")
		callNames := readNamedFunctionCallNames(t, "shein_submit_freshness.go", "evaluateSheinAttributeFreshness")
	...
	t.Run("resolved_attribute_home_routes_issue_state_and_message_shape_homes_only", func(t *testing.T) {
		...
		source := readNamedFunctionSource(t, "shein_submit_attribute_freshness_evaluation.go", "evaluateSheinResolvedAttributeFreshness")
		callNames := readNamedFunctionCallNames(t, "shein_submit_attribute_freshness_evaluation.go", "evaluateSheinResolvedAttributeFreshness")
	...
	t.Run("issue_state_home_owns_invalid_and_missing_required_collection", func(t *testing.T) {
		...
		source := readNamedFunctionSource(t, "shein_submit_attribute_freshness_issue_state.go", "evaluateSheinAttributeFreshnessIssueState")
		callNames := readNamedFunctionCallNames(t, "shein_submit_attribute_freshness_issue_state.go", "evaluateSheinAttributeFreshnessIssueState")
	...
	t.Run("message_shape_home_owns_drift_detail_and_outward_message_assembly", func(t *testing.T) {
		...
		source := readNamedFunctionSource(t, "shein_submit_attribute_freshness_message_shape.go", "buildSheinAttributeFreshnessOutcome")
		callNames := readNamedFunctionCallNames(t, "shein_submit_attribute_freshness_message_shape.go", "buildSheinAttributeFreshnessOutcome")
