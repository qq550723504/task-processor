...
var sheinAutoReviewNotes = []string{
...
func filterManualSheinReviewNotes(notes []string) []string {
	...
	auto := make(map[string]struct{}, len(sheinAutoReviewNotes))
	for _, note := range sheinAutoReviewNotes {
		auto[note] = struct{}{}
	}
