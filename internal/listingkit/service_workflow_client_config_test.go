...
func TestConfigureWorkflowClientsSyncDependencyGroups(t *testing.T) {
	t.Parallel()

	t.Run("task submitter updates task deps", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("shein publish workflow updates submission deps", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("standard workflow updates task deps", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("platform adapt workflow updates task deps", func(t *testing.T) {
		t.Parallel()
