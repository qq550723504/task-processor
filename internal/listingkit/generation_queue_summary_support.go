...
func buildGenerationWorkQueueSummary(items []GenerationWorkQueueItem) *GenerationWorkQueueSummary {
	...
	for _, item := range items {
		accumulateGenerationQueuePlatformMetrics(summary, item)
		accumulateGenerationQueuePreviewMetrics(summary, item)
		accumulateGenerationQueueStateMetrics(summary, item)
		accumulateGenerationQueueQualityMetrics(summary, item)
		accumulateGenerationQueueReviewMetrics(summary, item)
...
func accumulateGenerationQueuePlatformMetrics(summary *GenerationWorkQueueSummary, item GenerationWorkQueueItem) {
...
func accumulateGenerationQueuePreviewMetrics(summary *GenerationWorkQueueSummary, item GenerationWorkQueueItem) {
...
func accumulateGenerationQueueStateMetrics(summary *GenerationWorkQueueSummary, item GenerationWorkQueueItem) {
...
func accumulateGenerationQueueReviewMetrics(summary *GenerationWorkQueueSummary, item GenerationWorkQueueItem) {
