...
func TestGenerationNavigationFollowUpReadItemCloneBoundary(t *testing.T) {
	...
	t.Run("followup_read_clone_shape_home_owns_query_clone_delegation", func(t *testing.T) {
		...
		source := readNamedFunctionSource(t, "generation_navigation_descriptor_clone_shape_pairing.go", "applyGenerationNavigationFollowUpReadCloneShape")
		callNames := readNamedFunctionCallNames(t, "generation_navigation_descriptor_clone_shape_pairing.go", "applyGenerationNavigationFollowUpReadCloneShape")
