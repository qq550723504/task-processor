...
func TestGenerationNavigationFollowUpReadItemCloneBoundary(t *testing.T) {
	...
	t.Run("followup_read_clone_shape_home_owns_query_clone_delegation", func(t *testing.T) {
		...
		source := readNamedFunctionSource(t, "generation_navigation_followup_read_clone_shape.go", "applyGenerationNavigationFollowUpReadCloneShape")
		callNames := readNamedFunctionCallNames(t, "generation_navigation_followup_read_clone_shape.go", "applyGenerationNavigationFollowUpReadCloneShape")
