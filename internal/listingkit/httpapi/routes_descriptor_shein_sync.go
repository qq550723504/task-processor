...
func appendSheinSyncRouteDescriptors(routes []httproute.Descriptor, handler sheinSyncRouteHandler) []httproute.Descriptor {
	return append(routes,
		...
		httproute.Descriptor{Method: http.MethodPost, Path: "/api/v1/listing-kits/shein-sync/stores/:store_id/candidates/reset", Module: "listing-kit", Handler: handler.ResetSheinActivityCandidates},
		...
		httproute.Descriptor{Method: http.MethodGet, Path: "/api/v1/listing-kits/shein-sync/stores/:store_id/enrollment-runs/:run_id/items", Module: "listing-kit", Handler: handler.ListSheinActivityEnrollmentRunItems},
	)
}
