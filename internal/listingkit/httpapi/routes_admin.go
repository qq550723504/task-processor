...
type AdminRouteHandler interface {
	...
	ListAdminScheduledTaskConfigs(c *gin.Context)
	GetAdminScheduledTaskConfig(c *gin.Context)
	UpsertAdminScheduledTaskConfig(c *gin.Context)
	UpdateAdminScheduledTaskConfigStatus(c *gin.Context)
	DeleteAdminScheduledTaskConfig(c *gin.Context)
