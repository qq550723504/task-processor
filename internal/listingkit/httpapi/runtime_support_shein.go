...
func buildListingKitSheinCategoryResolver(storeRepo listingadmin.StoreRepository, cookieStore *sheinlogin.RedisStore, llm openaiclient.TextChatCompleter, cache sheinpub.ResolutionCacheStore) sheinpub.CategoryResolver {
...
func buildListingKitSheinAttributeResolver(storeRepo listingadmin.StoreRepository, cookieStore *sheinlogin.RedisStore, llm openaiclient.TextChatCompleter, cache sheinpub.ResolutionCacheStore) sheinpub.AttributeResolver {
...
func buildListingKitSheinSaleAttributeResolver(storeRepo listingadmin.StoreRepository, cookieStore *sheinlogin.RedisStore, llm openaiclient.TextChatCompleter, cache sheinpub.ResolutionCacheStore) sheinpub.SaleAttributeResolver {
