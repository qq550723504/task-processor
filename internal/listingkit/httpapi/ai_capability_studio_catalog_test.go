...
func TestStudioCapabilityCatalogMapsSelectorsWithoutExposingCredentials(t *testing.T) {
	tests := []struct {
		...
		{
			name:              "nanobanana grsai async style remains asynchronous",
			routingKey:        "nanobanana",
			config:            &openaiclient.ClientConfig{APIKey: "secret-banana", BaseURL: "https://compatible.example.test/v1", Model: "configured-banana", APIStyle: imageAPIStyleGRSAI},
			wantClientName:    listingKitImageClientNameNanobanana,
			wantModel:         "configured-banana",
			wantProvider:      imageAPIStyleGRSAI,
			wantAsync:         true,
		...
		{
			name:              "nanobanana blank style matches legacy GrsAI client",
			routingKey:        "nanobanana",
			config:            &openaiclient.ClientConfig{APIKey: "secret-banana", BaseURL: "https://compatible.example.test/v1", Model: "configured-banana"},
			wantClientName:    listingKitImageClientNameNanobanana,
			wantModel:         "configured-banana",
			wantProvider:      imageAPIStyleGRSAI,
			wantAsync:         true,
		...
		{
			name:              "nanobanana openai style matches legacy GrsAI client",
			routingKey:        "nanobanana",
			config:            &openaiclient.ClientConfig{APIKey: "secret-banana", BaseURL: "https://compatible.example.test/v1", Model: "configured-banana", APIStyle: imageAPIStyleOpenAI},
			wantClientName:    listingKitImageClientNameNanobanana,
			wantModel:         "configured-banana",
			wantProvider:      imageAPIStyleGRSAI,
			wantAsync:         true,
