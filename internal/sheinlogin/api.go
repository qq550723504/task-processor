...
func (h *Handler) Login(c *gin.Context) {
	...
	result, err := h.svc.Login(c.Request.Context(), storeID, req)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"success": false, "message": err.Error()})
		return
	}
...
func (h *Handler) Status(c *gin.Context) {
	...
	status, err := h.svc.Status(c.Request.Context(), storeID)
	if err != nil {
...
func (h *Handler) SubmitVerifyCode(c *gin.Context) {
	...
	if err := h.svc.SubmitVerifyCode(c.Request.Context(), storeID, req.Code, req.ExpireSeconds); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"success": false, "message": err.Error()})
		return
	}
...
func (h *Handler) CancelVerifyCodeWait(c *gin.Context) {
	...
	cancelled, err := h.svc.CancelVerifyCodeWait(c.Request.Context(), storeID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"success": false, "message": err.Error()})
		return
	}
...
func (h *Handler) ClearCookie(c *gin.Context) {
	...
	if err := h.svc.ClearCookie(c.Request.Context(), storeID); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"success": false, "message": err.Error()})
		return
	}
	c.JSON(http.StatusOK, gin.H{"success": true})
...
func (h *Handler) ClearLastFailure(c *gin.Context) {
	...
	if err := h.svc.ClearLastFailure(c.Request.Context(), storeID); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"success": false, "message": err.Error()})
		return
	}
	c.JSON(http.StatusOK, gin.H{"success": true})
...
func (h *Handler) GetLastFailure(c *gin.Context) {
	...
	detail, err := h.svc.GetLastFailureDetail(c.Request.Context(), storeID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"success": false, "message": err.Error()})
		return
	}
