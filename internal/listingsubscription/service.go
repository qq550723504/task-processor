	...
	return []PlanBundle{
		...
		},
		{
			...
			Modules: []PlanModule{
				...
				{PlanCode: PlanProfessional, ModuleCode: ModuleStudio, Limits: map[string]int{"design_jobs": 100, "product_image_jobs": 100, "shein_drafts_succeeded": 100}, SortOrder: 50},
		...
		},
		{
			...
			Modules: []PlanModule{
				...
				{PlanCode: PlanEnterprise, ModuleCode: ModuleStudio, Limits: map[string]int{"design_jobs": 1000, "product_image_jobs": 1000, "shein_drafts_succeeded": 1000}, SortOrder: 50},
