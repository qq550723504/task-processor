...
func runtimeOperationStrategyFromListing(strategy *listingadmin.OperationStrategy) *listingruntime.OperationStrategy {
	...
	return &listingruntime.OperationStrategy{
		...
		ActivityLimitedDiscountRate:  runtimeFloat64Value(strategy.ActivityLimitedDiscountRate),
		...
		ActivityLimitedMinProfitRate: runtimeFloat64Value(strategy.ActivityLimitedMinProfitRate),
...
func runtimeOperationStrategyFromListingAdminDTO(strategy *listingadmin.OperationStrategyDTO) *listingruntime.OperationStrategy {
	...
	return &listingruntime.OperationStrategy{
		...
		ActivityLimitedDiscountRate:  strategy.ActivityLimitedDiscountRate,
		...
		ActivityLimitedMinProfitRate: strategy.ActivityLimitedMinProfitRate,
		ActivityPriceMode:            strategy.ActivityPriceMode,
		ActivityPartakeType:          strategy.ActivityPartakeType,
