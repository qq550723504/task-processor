...
func (ed *ErrorDetector) IsBlockedOrSeriousError(err error) bool {
	...
	return ed.IsAuthenticationError(err) ||
		ed.IsTimeoutError(err) ||
		ed.IsCaptchaError(err) ||
		ed.IsServerError(err) ||
		ed.IsNetworkError(err) ||
		ed.IsBrowserCrashError(err) ||
		containsAny(err.Error(), seriousOnlyPatterns)
}
...
func (ed *ErrorDetector) IsTimeoutError(err error) bool {
	...
	return containsAny(err.Error(), timeoutPatterns)
}
...
func (ed *ErrorDetector) IsNetworkError(err error) bool {
	...
	return containsAny(err.Error(), networkPatterns)
}
...
func (ed *ErrorDetector) IsCaptchaError(err error) bool {
	...
	return containsAny(err.Error(), captchaPatterns)
}
...
func (ed *ErrorDetector) IsAuthenticationError(err error) bool {
	...
	return containsAny(err.Error(), authenticationPatterns)
}
...
func (ed *ErrorDetector) IsServerError(err error) bool {
	...
	return containsAny(err.Error(), serverPatterns)
}
...
func (ed *ErrorDetector) IsBrowserCrashError(err error) bool {
	...
	return containsAny(err.Error(), browserCrashPatterns)
}
...
func (ed *ErrorDetector) IsProductNotFoundError(err error) bool {
	...
	return containsAny(err.Error(), productNotFoundPatterns)
}
