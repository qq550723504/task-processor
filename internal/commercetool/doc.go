...
//
// Tool schemas are fixed to JSON Schema Draft 2020-12 and may reference only
// fragments in their own document. Construction fails closed when a schema can
...
// Principal, call, Agent, Tool, and permission fields are rejected at every
// semantic subschema path in both input and output schemas.
