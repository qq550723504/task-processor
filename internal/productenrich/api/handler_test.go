...
func TestGenerateProduct_InvalidRequestError_Returns400(t *testing.T) {
	svc := &mockHandlerSvc{createErr: errors.New("invalid request: product_url must be a valid 1688 product page URL")}
	r := newTestRouter(svc)
