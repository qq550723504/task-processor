...
type EnhancementSuggester interface {
	...
	GenerateSuggestions(ctx context.Context, validation *ValidationResult) (*EnhancementSuggestion, error)
...
// GenerateSuggestions 生成数据增强建议
func (s *enhancementSuggester) GenerateSuggestions(ctx context.Context, validation *ValidationResult) (*EnhancementSuggestion, error) {
	if validation == nil {
