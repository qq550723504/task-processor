...
type VariantGenerator interface {
	...
	GenerateSpecs(ctx context.Context, analysis *domain.ProductAnalysis) (*domain.ProductSpecs, error)
	// GenerateVariants 生成产品变体
	GenerateVariants(ctx context.Context, analysis *domain.ProductAnalysis) ([]domain.ProductVariant, error)
	// ExtractDimensions 提取尺寸信息
	ExtractDimensions(ctx context.Context, text string) (*domain.Dimensions, error)
	// ExtractWeight 提取重量信息
	ExtractWeight(ctx context.Context, text string) (*domain.Weight, error)
}
...
// GenerateSpecs 生成产品规格
func (v *variantGenerator) GenerateSpecs(ctx context.Context, analysis *domain.ProductAnalysis) (*domain.ProductSpecs, error) {
	if analysis == nil {
...
// GenerateVariants 生成产品变体
func (v *variantGenerator) GenerateVariants(ctx context.Context, analysis *domain.ProductAnalysis) ([]domain.ProductVariant, error) {
	if analysis == nil {
		return nil, fmt.Errorf("analysis cannot be nil")
	}
...
// ExtractDimensions 提取尺寸信息
func (v *variantGenerator) ExtractDimensions(ctx context.Context, text string) (*domain.Dimensions, error) {
	if text == "" {
...
// ExtractWeight 提取重量信息
func (v *variantGenerator) ExtractWeight(ctx context.Context, text string) (*domain.Weight, error) {
	if text == "" {
		return nil, fmt.Errorf("text cannot be empty")
	}
