...
func BuildAttributeEffects() []EditorEffect {
	return []EditorEffect{{
		...
		Label:          "属性修改影响",
		AffectedFields: []string{"shein.resolved_attributes", "shein.attribute_resolution", "shein.draft_payload.resolved_attributes"},
...
func BuildSaleAttributeEffects() []EditorEffect {
	return []EditorEffect{{
		...
		Label:          "规格修改影响",
		AffectedFields: []string{"shein.sale_attribute_resolution", "shein.draft_payload.skc_list", "shein.skc_list"},
