...
func TestValidateRevisionInputMarketplaceReportsInvalidCategory(t *testing.T) {
	invalidCategoryID := 0
...
func TestValidateRevisionInputMarketplaceReportsInvalidSKUPatch(t *testing.T) {
	negativeStock := -1
