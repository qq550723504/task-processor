...
func ResolveRenderedSizeReferenceImages(rawRefs []string, sourceMockups []string, renderedMockups []string) []string {
	rawRefs = uniqueNonEmptySDSImageStrings(rawRefs)
	sourceMockups = uniqueNonEmptySDSImageStrings(sourceMockups)
	renderedMockups = uniqueNonEmptySDSImageStrings(renderedMockups)
	...
	return uniqueNonEmptySDSImageStrings(rendered)
}
