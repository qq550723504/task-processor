...
func (h *PricingRuleHandler) ListPricingRules(c *gin.Context) {
	...
	page, err := h.repo.ListPricingRules(c.Request.Context(), query)
	if err != nil {
...
func (h *PricingRuleHandler) GetPricingRule(c *gin.Context) {
	...
	rule, err := h.repo.GetPricingRule(c.Request.Context(), requestTenantID(c), id)
	if err != nil {
...
func (h *PricingRuleHandler) CreatePricingRule(c *gin.Context) {
	...
	rule, err := h.repo.CreatePricingRule(c.Request.Context(), &req)
	if err != nil {
...
func (h *PricingRuleHandler) UpdatePricingRule(c *gin.Context) {
	...
	rule, err := h.repo.UpdatePricingRule(c.Request.Context(), &req)
	if err != nil {
...
func (h *PricingRuleHandler) UpdatePricingRuleStatus(c *gin.Context) {
	...
	rule, err := h.repo.UpdatePricingRuleStatus(c.Request.Context(), requestTenantID(c), id, req.Status, req.Remark)
	if err != nil {
...
func (h *PricingRuleHandler) DeletePricingRule(c *gin.Context) {
	...
	if err := h.repo.DeletePricingRule(c.Request.Context(), requestTenantID(c), id); err != nil {
