...
func (h *OperationStrategyHandler) ListOperationStrategies(c *gin.Context) {
	...
	page, err := h.repo.ListOperationStrategies(c.Request.Context(), query)
	if err != nil {
...
func (h *OperationStrategyHandler) GetOperationStrategy(c *gin.Context) {
	...
	strategy, err := h.repo.GetOperationStrategy(c.Request.Context(), requestTenantID(c), id)
	if err != nil {
...
func (h *OperationStrategyHandler) CreateOperationStrategy(c *gin.Context) {
	...
	strategy, err := h.repo.CreateOperationStrategy(c.Request.Context(), &req)
	if err != nil {
...
func (h *OperationStrategyHandler) UpdateOperationStrategy(c *gin.Context) {
	...
	strategy, err := h.repo.UpdateOperationStrategy(c.Request.Context(), &req)
	if err != nil {
...
func (h *OperationStrategyHandler) UpdateOperationStrategyStatus(c *gin.Context) {
	...
	strategy, err := h.repo.UpdateOperationStrategyStatus(c.Request.Context(), requestTenantID(c), id, req.Status, req.Remark)
	if err != nil {
...
func (h *OperationStrategyHandler) DeleteOperationStrategy(c *gin.Context) {
	...
	if err := h.repo.DeleteOperationStrategy(c.Request.Context(), requestTenantID(c), id); err != nil {
