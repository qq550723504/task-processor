...
func TestRegisterCreatesCurrentPendingResource(t *testing.T) {
	...
	if authorizer.lastUser != "" || authorizer.lastPermission != authz.PermissionWorkbenchSourceAccountManage {
...
func TestReadUsesScopedStoreAndReadPermission(t *testing.T) {
	...
	if authorizer.lastUser != "" || authorizer.lastPermission != authz.PermissionWorkbenchSourceAccountRead {
