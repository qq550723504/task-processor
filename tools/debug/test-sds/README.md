...
go run ./test-sds -mode sync-url -token <access-token> -merchant-id <merchant-id> -variant-id 89764 -image-url https://example.com/design.png
go run ./test-sds -mode sync-file -token <access-token> -merchant-id <merchant-id> -variant-id 89764 -image-file ./design.png
go run ./test-sds -mode sync-result-file -token <access-token> -merchant-id <merchant-id> -variant-id 89764 -result-file ./result.json
go run ./test-sds -mode process-and-sync -token <access-token> -merchant-id <merchant-id> -variant-id 89764 -image-url https://example.com/source.jpg
```
