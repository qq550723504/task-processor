...
function BusinessProfilePanel({ profile, organizationId }: { profile?: AccountBusinessProfile | null; organizationId?: string }) {
  ...
  return <Panel title="经营画像" description="与首次完善资料使用相同的经营信息；保存后仍由账户中心 owner 持久化。" className={styles.business}><form className={styles.businessForm} onSubmit={submit}>
    {scalar("userRole", "你是什么角色？", ["跨境电商创业者", "跨境电商卖家", "工厂或供应商", "企业电商团队", "OPC电商社区或园区", "电商服务商", "其他"])}
    {scalar("shopSituation", "你目前有没有店铺？", ["暂时没有店铺", "正在准备开店", "已有店铺", "有多个店铺或店群"])}
    {multiple("platforms", "店铺平台", ["Amazon", "SHEIN", "Temu", "TikTok Shop", "Walmart", "Shopee", "Lazada", "AliExpress", "Etsy", "独立站"])}
    {multiple("sites", "经营站点", ["美国站", "加拿大站", "日本站", "英国站", "欧洲站"])}
    {scalar("shopType", "店铺类型", ["全托店", "半托店", "自营店", "其他"])}
    {scalar("factorySituation", "工厂与供应链", ["有自有工厂", "有长期合作工厂", "有稳定供应链资源", "暂时没有工厂或供应链资源", "其他"])}
    {multiple("services", "所需服务", ["AI选品与市场分析", "商品采集与刊登", "商品图片与内容生成", "POD商品定制", "供应链与货盘对接", "店铺智能运营", "广告投放与优化", "客服自动化", "订单库存与ERP", "多店铺矩阵管理", "创业培训与陪跑", "店铺联合运营", "品牌出海", "企业功能定制", "OPC电商社区落地", "暂时不确定"])}
