...
export function MarketingHomepage() {
  return <main className={styles.page}>
    ...
    <footer className={styles.footer}><div className={styles.footerBrand}><Image src={`${ASSET}/c3ea4c6f-992f-4c3d-ae2e-c14d4ec9735a.png`} width={38} height={38} alt="" /><div><strong>硕米智能引擎</strong><span>新一代人工智能电商操作系统</span></div></div><div className={styles.footerLinks}><a href="#agents">产品能力</a><a href="#solutions">解决方案</a><a href="#services">服务支持</a><a href="#practices">应用实践</a><a href="#pricing">价格方案</a></div><div className={styles.copyright}>© 2026 硕米智能引擎　保留所有权利 <span><Link href="/privacy-policy">隐私政策</Link><Link href="/user-agreement">用户协议</Link><Link href="/ai-compute-billing">算力计费说明</Link><Link href="/service-agreement">服务协议</Link></span></div></footer>
    <ContactPanel />
  </main>;
}
