...
import Home from "@/app/listing-kits/home/page";
...
describe("Home", () => {
  it("renders the canonical-product centered homepage layout", () => {
    ...
    expect(screen.getByText("生成标准商品")).toBeInTheDocument();
    ...
    expect(
      screen.getByRole("link", { name: "查看标准商品" }),
    ...
    expect(
      screen.getByRole("link", { name: "标准商品" }),
    ).toHaveAttribute("href", "/listing-kits/canonical-products");
    expect(
