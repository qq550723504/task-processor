...
describe("useLiveSearchParams", () => {
  it("hydrates from the browser location after mount", async () => {
    window.history.replaceState(null, "", "/listing-kits/canonical-products?keyword=beer&page=1");
  ...
  it("updates after replaceBrowserHistory changes the query string", async () => {
    ...
    replaceBrowserHistory("/listing-kits/canonical-products?keyword=cola&page=1");
