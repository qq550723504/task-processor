...
export const listingKitKeys = {
  ...
  sheinActivityStrategy: (storeId: number, activityType: string) =>
    [
      "listingkit",
      "shein-enrollment",
      storeId,
  ...
  sheinEnrollmentProductsScope: (storeId: number) =>
    ["listingkit", "shein-enrollment", storeId, "products"] as const,
  ...
  sheinEnrollmentSourceSDSCostGroupsScope: (storeId: number) =>
    ["listingkit", "shein-enrollment", storeId, "source-sds-cost-groups"] as const,
  ...
  preview: (taskId: string, freshnessKey?: string, platform?: string) =>
    ["listingkit", taskId, "preview", freshnessKey ?? "", platform ?? ""] as const,
