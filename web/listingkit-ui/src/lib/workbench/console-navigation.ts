...
export const consoleNavigation: readonly ConsoleNavNode[] = [
  ...
  { label: "我的账户", href: "/workbench/account", availability: "connected", children: [{ label: "账户资料", href: "/workbench/account/profile", availability: "connected" }, { label: "企业空间", href: "/workbench/account/organization", availability: "connected", children: [pending("成员与权限", "account/organization/members"), pending("资源与额度", "account/organization/resources"), { label: "操作记录", href: "/workbench/account/organization/audit", availability: "connected" }] }, pending("推广与收益", "account/referrals")] },
];
