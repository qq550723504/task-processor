...
export const consoleNavigation: readonly ConsoleNavNode[] = [
  ...
  { label: "我的账户", href: "/workbench/account", availability: "connected", children: [{ label: "账户资料", href: "/workbench/account/profile", availability: "connected" }, { label: "企业空间", href: "/workbench/account/organization", availability: "connected", children: [pending("成员与权限", "account/organization/members"), { label: "资源与额度", href: "/workbench/account/organization/resources", availability: "connected" }, pending("操作记录", "account/organization/audit")] }, pending("推广与收益", "account/referrals")] },
];
