...
const legacyOrder = orderBase.extend({ kind: z.enum(["WALLET_TOP_UP", "RESOURCE_PURCHASE"]), failure_code: z.enum(["INSUFFICIENT_FUNDS", "RESOURCE_GRANT_REJECTED"]).optional() }).strict();
...
const order = z.union([legacyOrder, subscriptionOrder]);
