...
const errorCodes: Record<number, readonly string[]> = {
  ...
  405: ["INVALID_REQUEST"], 409: ["IDENTITY_CONTEXT_CHANGED", "ORGANIZATION_CONTEXT_CHANGED", "ORGANIZATION_SELECTION_REQUIRED", "CONFLICT", "PAYOUT_ELIGIBILITY_UNMET", "INVALID_TRANSITION"],
  422: ["IDENTITY_PROVIDER_REJECTED", "IDENTITY_VERIFICATION_FAILED"],
  502: ["INVALID_UPSTREAM_RESPONSE", "DEPENDENCY_UNAVAILABLE", "RESULT_UNVERIFIED"], 503: ["ACCOUNT_NOT_CONFIGURED", "DEPENDENCY_UNAVAILABLE", "PAYOUT_METHOD_UNAVAILABLE", "REFERRALS_NOT_CONFIGURED"], 504: ["DEADLINE_EXCEEDED", "RESULT_UNVERIFIED"],
};
